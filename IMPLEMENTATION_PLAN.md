...
- Beta prep: commit hygiene DONE 2026-09-23 (tree clean; annotation fix plan landed as PRs #1–3, CI rot fixed as PR #4, all merged). Remaining: keyed structured-generation proof (wiki gen vs live Gemini), Ollama-offline gate if a server is available.
